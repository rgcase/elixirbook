defmodule Pooly.PoolServer do
    ...
    defmodule State do
        defstruct pool_sup: nil, worker_sup: nil, monitors: nil, 
                  size: nil, workers: nil, name: nil, mfa: nil,
                  overflow: 0, max_overflow: nil, waiting: nil
    end
    ...
    def handle_call({:checkout, block}, {from_pid, _ref}, %{worker_sup: worker_sup, workers: workers, monitors: monitors, overflow: overflow, max_overflow: max_overflow, waiting: waiting} = state) do
        case workers do
            [worker | rest] ->
    ...
    defp supervisor_spec(name, mfa) do
        opts = [id: name, restart: :temporary]
